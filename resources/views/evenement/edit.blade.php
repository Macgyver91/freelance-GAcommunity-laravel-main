        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" style="text-transform: uppercase; margin: auto">Modification Evenement</h4>
                </div>
                <div class="card-body">
                    <div class="create-event-form">
                        <form action="{{ route('admin.update_event', $evenement) }}" method="POST"
                            ...
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    <div>
                                        ...
                                        <select id="type" name="type" class="form-control" @error('type') border-warning
                                            @enderror value="type">
                                            <option {{ $evenement->type === 'N1' ? 'selected' : '' }} value="N1">N1
                                            </option>
                                            <option {{ $evenement->type === 'N2' ? 'selected' : '' }} value="N2">N2
                                            </option>
                                            <option {{ $evenement->type === 'N3' ? 'selected' : '' }} value="N3">N3
                                            </option>
                                            <option {{ $evenement->type === 'N4' ? 'selected' : '' }} value="N3">N4
                                            </option>
                                        </select>
                                    </div>
                                    @error('type')
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <div>
                                        ...
                                        <input value="{{ $evenement->numero_week_end }}" type="number"
                                            name="numero_week_end"
                            ...
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    <div>
                                        ...
                                        <select id="pays" name="pays"
                                            class="form-control @error('pays') border-warning
                                        @enderror ">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <div>
                                        ...
                                        <input value="{{ $evenement->ville }}" type="text" name="ville"
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <div>
                                        ...
                                        <input type="date" name="date_debut"
                                            ...
                                            id="date_debut" placeholder="date de debut" value="{{ $date_debut }}">
                                    </div>
                                    @error('date_debut')
                                        <div class="text-warning">
                                            {{ $message }}
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <div>
                                        ...
                                        <input type="date" name="date_fin"
                                            ...
                                            id="date_fin" placeholder="date de fin" value="{{ $date_fin }}">
                                    </div>
                                    @error('date_fin')
                                        <div class=" text-warning">
                                            {{ $message }}
                            ...
                            <div class="form-row">
                                <div class="form-group col-12 col-md-4">
                                    <div>
                                        ...
                                        <input value=" {{ $evenement->centre }} " type="text" name="centre"
                                ...
                                <div class="form-group col-12 col-md-4">
                                    <div>
                                        ...
                                        <input value="{{ $evenement->lieu }}" type="text" name="lieu"
                                ...
                                <div class="form-group col-12 col-md-4">
                                    <div>
                                        ...
                                        <input value="{{ $evenement->adresse }}" type="text" name="adresse"
                            ...
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    <div>
                                        <label class="" for="coach">Toach</label>
                                        <input value="{{ $evenement->coach }}" type="text" name="coach"
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <div>
                                        ...
                                        <input value="{{ $evenement->tarif }}" type="number" step="0.01" name="tarif"
