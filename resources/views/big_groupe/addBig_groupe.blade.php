        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" style="text-transform: uppercase; margin: auto">Creation de grand groupe</h4>
                </div>
                <div class="card-body">
                    <div class="create-event-form">
                        <form action="{{ route('admin.add_big_groupe') }}" enctype="multipart/form-data" id="form"
                            method="POST">
                            @csrf
                            ...
                            <div class="borderP p-3 mb-3">
                                <div class="form-row">
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <select id="type" name="type"
                                            class="form-control @error('type') border-warning
                                        @enderror">
                                ...
                                <div class="form-row">
                                    <div class="form-group col- 12 col-md-6">
                                        <div>
                                            <label class="sr-only" for="mantra">Mantra</label>
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        <div>
                                            <label class="sr-only" for="declaration">Declaration</label>
                            ...
                            <div class="borderP p-3 mb-3">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-12 col-md-4">
                                        <div class="mb-3 mb-3">
                                            <audio class="mt-2" id="prev-audio" controls src="">
                                                Votre navigateur ne support pas
                                                <code>ce type de fichier.</code>
                                            </audio>
                                        </div>
                                        <div>
                                            <label class="sr-only" for="musique_choree">Music choree</label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <div>
                                            <label class="sr-only" for="video_choree">Video choree</label>
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                        ...
                                        <div>
                                            <label class="sr-only" for="photo_drapeau">Photo drapeau</label>
                            ...
                            <div class="borderP p-3 mb-3">
                                <div class="form-row">
                                    <div class="form-group col-12 col-md-4">
                                        <div>
                                            ...
                                            <select name="capitaine" id="capitaine"
                                                ...
                                                <option value="">Selectionner un capitaine
                                                </option>
                                    ...
                                    <div class="form-group col-12 col-md-4">
                                        <div>
                                            <label class="sr-only" for="resp_com">Responsable com</label>
                                            <select name="resp_com" id="resp_com"
                                                class="form-control @error('resp_com') border-warning @enderror">
                                                <option value="">Selectionner un reponsable com
                                                </option>
                                                @foreach ($allMembres as $membre)
                                                    <option value="{{ $membre->id }}">
                                                        {{ json_decode($membre->info)->nom }}
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12 col-md-4">
                                        <div>
                                            <label class="sr-only" for="resp_heritage">Responsable heritage</label>

                                            <select name="resp_heritage" id="resp_heritage"
                                                class="form-control @error('resp_heritage') border-warning @enderror">
                                                <option value="">Selectionner un reponsable heritage
                                                </option>
                                                @foreach ($allMembres as $membre)
                                                    <option value="{{ $membre->id }}">
                                                        {{ json_decode($membre->info)->nom }}
                                    ...
                                    <div class="form-group col-12 col-md-4">
                                        <div>
                                            <label class="sr-only" for="resp_anges">Responsable anges</label>

                                            <select name="resp_anges" id="resp_anges"
                                                class="form-control @error('resp_anges') border-warning @enderror">
                                                <option value="">Selectionner un reponsable anges
                                                </option>
                                                @foreach ($allMembres as $membre)
                                                    <option value="{{ $membre->id }}">
                                                        {{ json_decode($membre->info)->nom }}
                                    ...
                                    <div class="form-group col-12 col-md-4">
                                        <div>
                                            <label class="sr-only" for="resp_bateau">Responsable bateau</label>

                                            <select name="resp_bateau" id="resp_bateau"
                                                class="form-control @error('resp_bateau') border-warning @enderror">
                                                <option value="">Selectionner un reponsable bateau
                                                </option>
                                                @foreach ($allMembres as $membre)
                                                    <option value="{{ $membre->id }}">
                                                        {{ json_decode($membre->info)->nom }}
