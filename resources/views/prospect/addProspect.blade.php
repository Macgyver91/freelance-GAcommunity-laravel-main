        ...
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-header" style="text-align: center ">
                    <h4 class="card-title" style="text-transform: uppercase; margin: auto">Creation de prospect
                    </h4>
                </div>
                <div class="card-body">
                    <div class="create-event-form">
                        <form action="{{ route('admin.store_prospect') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-row">
                                <div class="form-group col-12">
                                    ...
                                    <select id="type" name="type" class="form-control" @error('type') border-warning
                                        @enderror>
                                        <option value="">Selectionnez votre type</option>
