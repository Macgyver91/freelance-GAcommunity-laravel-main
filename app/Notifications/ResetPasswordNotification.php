...
class ResetPasswordNotification extends Notification
{
     ...
     * @return void
     */
    public function __construct($token, $prenom)
    {
        $this->token = $token;
        $this->prenom = $prenom;
    }
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ...
            ->greeting("Bonjour $this->prenom", ['prenom' => $this->prenom])
            ...
            ->line(Lang::get("Si vous n'avez pas demandé la réinitialisation de mot de passe, aucune autre action n'est requise."));
    }
